                ...
                <div style="height: auto" class="job-detail border rounded p-3">
                    <div class="job-detail-content">
                        ...
                        <div class="job-detail-com-desc overflow-hidden d-block">
                            ...
                            <p class="overflow-hidden text-muted mb-0"><i class="mdi mdi-link-variant mr-2"></i><a class="apply-button" data-jid="<?php echo get_the_ID(); ?>" target="_blank" href="<?php echo pick_job_website(); ?>">Apply Now <?php //echo $company[0]->name; ?> </a></p>
