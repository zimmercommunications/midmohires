...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_5f91f4a0d65cd',
			'label' => 'Compensation and Benefits',
			'name' => 'compensation',
			'type' => 'wysiwyg',
			'instructions' => 'If applicable, list the compensation related to the job.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '100',
		...
		array(
			'key' => 'field_5f91f4cad65ce',
			'label' => 'More Information',
			'name' => 'more_info',
			'type' => 'wysiwyg',
			'instructions' => 'If applicable, list any addition information related to the job.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '100',
